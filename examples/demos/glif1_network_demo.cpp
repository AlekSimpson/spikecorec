// GLIF1 balanced excitatory/inhibitory network, randomly wired
//
// The cell is leaky integrate-and-fire with a refractory period.
//
// Produces build/demos/glif1_network_membrane.mp4 (with .nml, LEMS, .spire and spikes beside it).
...
int main() {
    ...
    const String name = "glif1_network";
    ...
    report_demo(name,
                "GLIF1 balanced network: 400 excitatory + 100 inhibitory, "
                "randomly wired.\nThe cell is leaky integrate-and-fire with a refractory period.",
