// GLIF5 on a 1024x1024 torus: 1,048,576 cells, 4,194,304 edges
//
...
//
// Produces build/demos/glif5_million_membrane.mp4 (with .nml, LEMS, .spire and spikes beside it).
...
int main() {
    ...
    const String name = "glif5_million";
    ...
    report_demo(name,
                "GLIF5 on a 1024x1024 square torus.\n96 recorded frames is 8 seconds at 12 fps, and at 4 MB a frame that is\n// 384 MB of recording. Render time, not disk, is what caps this: each\n// 2560x1628 frame of a million points takes about a second to draw.",
