// GLIF2 on a torus under scattered spike-train input
//
...
//
// Produces build/demos/glif2_scatter_membrane.mp4 (with .nml, LEMS, .spire and spikes beside it).
...
int main() {
    ...
    const String name = "glif2_scatter";
