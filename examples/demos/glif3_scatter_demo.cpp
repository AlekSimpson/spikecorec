// GLIF3 on a torus under scattered spike-train input
//
...
//
// Produces build/demos/glif3_scatter_membrane.mp4 (with .nml, LEMS, .spire and spikes beside it).
...
int main() {
    ...
    const String name = "glif3_scatter";
