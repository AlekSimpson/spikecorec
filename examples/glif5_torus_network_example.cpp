...
//
// ── The weight caveat ───────────────────────────────────────────────────────────────────────────
// As in the GLIF3 example, the value scattered to downstream neurons is a PLACEHOLDER set by
// `--weight`, not something derived from the model's synapse parameters — the propagate stage does
// not yet invoke per-edge synapse dynamics. Topology and timing are real; magnitude is stipulated.
//
// Run:  ./build/examples/glif5_torus_network_example [--side 8] [--ticks 5000] [--weight 2.5e-8]
...
int main(int argument_count, char **argument_values) {
    ...
    // ── 6. The two adaptation mechanisms, side by side ──────────────────────────────────────────
