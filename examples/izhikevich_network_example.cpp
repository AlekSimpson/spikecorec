...
int main(int argument_count, char **argument_values) {
    ...
    // Forced to zero for the same reason as the GLIF E/I example: the propagate stage does not yet
    // invoke real per-edge synapse dynamics, so only the driven population is meaningful here.
