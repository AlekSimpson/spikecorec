...
int main(int argument_count, char **argument_values) {
    ...
    String membrane_recording_path = options.record_directory + "/glif2_torus_membrane.spire";
    String spike_recording_path = options.record_directory + "/glif2_torus_spikes.spire";
    if (options.record) {
