...
int main(int argument_count, char **argument_values) {
    ...
    // ── 2. Allocation and the GLIF4-specific initial state ──────────────────────────────────────
    ...
    seed_glif_initial_state(allocation, model, GlifVariant::Glif4);
    ...
    String membrane_recording_path = options.record_directory + "/glif4_torus_membrane.spire";
    String spike_recording_path = options.record_directory + "/glif4_torus_spikes.spire";
    if (options.record) {
