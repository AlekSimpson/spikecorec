...
namespace spikecorec {
    ...
    vector<vector<s32>> small_world_torus(s64 side_length, s32 random_fanout = 4, s64 seed = -1);
    ...
    vector<vector<s32>> random_fixed_outdegree(s64 side_length, s32 fanout = 8, s64 seed = -1);
